...
#[test]
fn cash_flow_planned_expenses_do_not_double_count_parent_budget_rollups() {
    let budgets = vec![
        BudgetCode {
            code: "HOME".to_string(),
            parent_code: String::new(),
            ...
            monthly_budget: Some(BudgetAmount::Fixed(Decimal::new(10, 0))),
            yearly_budget: None,
            direction: BudgetDirection::Expense,
            income_basis: BudgetIncomeBasis::RealIncome,
            notes: String::new(),
        ...
        BudgetCode {
            ...
            monthly_budget: Some(BudgetAmount::Fixed(Decimal::new(70, 0))),
            yearly_budget: None,
            direction: BudgetDirection::Expense,
            income_basis: BudgetIncomeBasis::RealIncome,
            notes: String::new(),
        ...
        BudgetCode {
            ...
            monthly_budget: Some(BudgetAmount::Fixed(Decimal::new(20, 0))),
            yearly_budget: None,
            direction: BudgetDirection::Expense,
            income_basis: BudgetIncomeBasis::RealIncome,
            notes: String::new(),
    ...
    let breakdown =
        cash_flow_breakdown_for_year(&[], &budgets, 2025, ComparisonMode::CurrentOnly, usize::MAX)
            .unwrap();
    let planned_total = breakdown
        .current
        .planned_expenses
        .iter()
    ...
    assert_eq!(planned_total, Decimal::new(1200, 0));
}
