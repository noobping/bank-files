...
use super::render::set_management_form_action_buttons_sensitive;
...
pub(super) struct ManagementDialogSetup<'a> {
    ...
    pub(super) group_rules_button: &'a gtk::Button,
    pub(super) combine_rules_button: &'a gtk::Button,
    pub(super) add_budget_button: &'a gtk::Button,
    pub(super) move_budget_code_button: &'a gtk::Button,
    pub(super) use_real_income_button: &'a gtk::Button,
    pub(super) use_planned_income_button: &'a gtk::Button,
    pub(super) use_monthly_values_button: &'a gtk::Button,
    pub(super) use_yearly_values_button: &'a gtk::Button,
