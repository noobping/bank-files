...
use download::{build_download_dialog, confirm_install, download_release, show_alert};
...
use types::{
    CheckMode, DownloadMessage, DownloadOutcome, DownloadedUpdate, GitHubReleaseResponse,
    GITHUB_API_ACCEPT, GITHUB_API_VERSION, GITHUB_RELEASES_PER_PAGE, WORKER_POLL_INTERVAL_MS,
};
#[cfg(target_os = "linux")]
use types::{
