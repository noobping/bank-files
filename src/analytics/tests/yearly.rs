...
#[test]
fn annual_budget_usage_rolls_child_budgets_into_parent_rows() {
    let rows = vec![
        tx("2025-01-01", -100, "Housing", "HOME"),
        tx("2025-01-02", -700, "Rent", "RENT"),
    ];
    let budgets = vec![
        BudgetCode {
            code: "HOME".to_string(),
        ...
        BudgetCode {
            ...
            monthly_budget: Some(BudgetAmount::Fixed(Decimal::new(600, 0))),
            yearly_budget: None,
            direction: BudgetDirection::Expense,
            income_basis: BudgetIncomeBasis::RealIncome,
            notes: String::new(),
    ...
    assert_eq!(home.actual, Decimal::new(800, 0));
    assert_eq!(home.budget, Decimal::new(8400, 0));
    assert_eq!(home.remaining, Decimal::new(7600, 0));
